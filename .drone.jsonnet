        ...
        },
    {
...
] + ( if arch == "amd64" then [
        {
            ...
            commands: [
              ...
              "cd integration",
              "./deps.sh",
              "py.test -x -s verify.py --distro=jessie --domain=jessie.com --app-archive-path=$APP_ARCHIVE_PATH --device-host=collabora.jessie.com --app=" + name + " --arch=" + arch
            ]
        }] else []) + [
        {
            ...
            commands: [
              ...
              "cd integration",
              "./deps.sh",
              "py.test -x -s verify.py --distro=buster --domain=buster.com --app-archive-path=$APP_ARCHIVE_PATH --device-host=collaborq.buster.com --app=" + name + " --arch=" + arch
            ]
        }] + ( if test_ui then [
    {
        name: "selenium-video",
    ...
    },
        {
            ...
            commands: [
              "cd integration",
              "./deps.sh",
              "py.test -x -s test-ui.py --distro=jessie --ui-mode=desktop --domain=jessie.com --device-host=collabora.jessie.com --app=" + name + " --browser=" + browser,
            ],
            volumes: [{
                name: "shm",
                path: "/dev/shm"
        ...
        },
        {
            ...
            commands: [
              "cd integration",
              "./deps.sh",
              "py.test -x -s test-ui.py --distro=jessie --ui-mode=mobile --domain=jessie.com --device-host=collabora.jessie.com --app=" + name + " --browser=" + browser,
            ],
            volumes: [{
                name: "shm",
                path: "/dev/shm"
        ...
        },
        {
            ...
            commands: [
              "cd integration",
              "./deps.sh",
              "py.test -x -s test-ui.py --distro=buster --ui-mode=desktop --domain=buster.com --device-host=collabora.buster.com --app=" + name + " --browser=" + browser,
            ],
            volumes: [{
                name: "shm",
                path: "/dev/shm"
        ...
        },
        {
            ...
            commands: [
              "cd integration",
              "./deps.sh",
              "py.test -x -s test-ui.py --distro=buster --ui-mode=mobile --domain=buster.com --device-host=collabora.buster.com --app=" + name + " --browser=" + browser,
            ],
            volumes: [{
                name: "shm",
                path: "/dev/shm"
